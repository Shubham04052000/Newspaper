...
$sqlq="INSERT INTO `admins` ( `username`, `password`) VALUES ( '$username', '$password')";
...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" required id="cpassword"  placeholder="Enter your cpassword" name ="cpassword">
